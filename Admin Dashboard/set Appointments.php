<?php
  ...
  if(isset($_POST['submit'])){
   ...
   include'GBJ Realty Admin Dashboard.php';
}
...
<head>
    ...
    <title>GBJ Realty | Set Appointments</title>
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__wobble" src="dist/img/GBJ Realty logo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="GBJ Realty Admin Dashboard.php" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="set Appointments.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Set Appointment</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Appointment form</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="GBJ Realty Admin Dashboard.php">Home</a></li>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="date" name="date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
